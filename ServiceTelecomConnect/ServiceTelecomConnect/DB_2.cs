...
namespace ServiceTelecomConnect
{
    class DB_2 //для копирования radiostantion в radiostantion_copy в отдельном потоке по таймеру
    {
        ...
        /// </summary>
        MySqlConnection connection = new MySqlConnection("server=31.31.198.62;port=3306;username=u1748936_db_2_1;password=war74_89;database=u1748936_radiostantion;charset=utf8");
