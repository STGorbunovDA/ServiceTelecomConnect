...
namespace ServiceTelecomConnect
{
    public partial class RemontRSTForm : Form
    {
        ...
        string[] motorolaGP340_work = { "Замена антенны", "Замена антенного разъёма", "Замена батарейных контактов",
            ...
            "Замена динамика", "Замена заглушки", "Замена кабеля динамика", "Замена катушки индуктивности",
        ...
        string[] motorolaGP340_part = { "Антенна NAD6502 146-174Mгц", "0180117S05 Антенный разъем для GP-340",
            "0986237А02 Контакты для подсоед.аккум.в серии р/ст WARIS", "3580998Z04 Войлок", "3580998Z05 Войлок",
            "3586057А02 Войлок GP340", "3280533Z05 Герметик верхней панели", "1380528Z01 Держатель боковой клавиатуры для GP-340",
            "5005589U05 Динамик для GP-300/600", "HLN9820 Заглушка для GP-серии", "3080560D01 Кабель динамика",
            ...
            "1880619Z06 Регулятор громкости для GP-340", "3680530Z02 Ручка переключения каналов GP-340", "3680539Z02 Ручка переключения каналов 16 позиций",
        ...
        string[] motorolaDP2400_work = { "Замена технологического РЧ разъема", "Замена кронштейна РТТ",
            ...
            "Замена гибкого соединительного шлейфа", "Замена динамика" };
        ...
        string[] motorolaDP2400_part = { "MS-147 РЧ разъем технологический", "75012087001 Кронштейн РТТ",
            ...
            "0104045J62 Гибкий соединительный шлейф", "50012013001 Динамик" };
        ...
        string[] Icom_part = {"Антенный разъем для F16 (6910015910)", "Антенный разъем для F3G (8950005260)", "Антенна FA-SC55V для IC-F3S/IC-F3GS",
            ...
            "2251-S FRONT PANEL-1 Корпус", "Корпус для IC-F16 (с вклееным динамиком защелкой АКБ линзой)", "BU4066BCFV-E1 IC Микросхема",
            "CDBCA450CX24 микросборка дискриминатор", "HD6473877H (Z-TAT) IC микросхема", "S.IC HN 58X2432TI Микросхема", "UPD3140GS-E1 (DS8) IC Микросхема",
            ...
            "Транзистор UNR911HJ (TX)", "Транзистор XP6501-(TX).AB", "2251 JACK RUBBER Резин.уплотнитель разъема гарнитуры IC-F3/4/GT/GS",
            "2251 MAIN SEAL Уплотнительная резинка", "Фильтр S.XTRAL CR-664A 15.300 MHz", "2251 CHASSIS-7 ШАССИ", "Шасси 2251 CHASSIS-3", 
        ...
        string[] Altavia_part = { "45Т151AF/UF-5.3S SMD 45MHz Фильтр", "DA 10 (S-812C50AUA (S1F78101Y3BO )", "ZQ1 (44.545 МГц-UM-5S Резонатор",
                ...
                if (!String.IsNullOrEmpty(txB_сompleted_works_1.Text) && !String.IsNullOrEmpty(txB_parts_1.Text))
                {
                    ...
                    try
                    {
                        ...
                        if (numberActRemont == "53/" || numberActRemont == "" || numberActRemont == "5" || numberActRemont == "53"
                            || numberActRemont == "3" || numberActRemont == "/")
                        {
