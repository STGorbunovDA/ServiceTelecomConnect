...
namespace ServiceTelecomConnect
{
    public class MyTwoColumnComparer : System.Collections.IComparer
    {
        ...
        public int Compare(object x, object y)
        {
            ...
            int iCompareResult = _SortOrderMultiplier1 * String.Compare(r1.Cells[_SortColumnName1].Value.ToString(), r2.Cells[_SortColumnName1].Value.ToString(), false);
            if (iCompareResult == 0) iCompareResult = _SortOrderMultiplier2 * String.Compare(r1.Cells[_SortColumnName2].Value.ToString(), r2.Cells[_SortColumnName2].Value.ToString(),true);
           // else if (iCompareResult == -1) iCompareResult = _SortOrderMultiplier1 * String.Compare(r2.Cells[_SortColumnName2].Value.ToString(), r1.Cells[_SortColumnName2].Value.ToString(), true);
